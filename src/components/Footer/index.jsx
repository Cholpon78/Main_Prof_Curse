        ...
        <div className={s.contacts}>
          <div className={s.contacts_wrapper}>
            ...
            <div className={s.contact_color}>
              ...
              <address className={s.coordination_wrapper}>
                <Link to="https://www.google.com/maps?q=Linkstraße+2,+10785+Berlin,+Deutschland">
                  <p className={s.address}>Linkstraße 2, 8 OG, 10785,</p>
                  <span className={s.address}>Berlin, Deutschland</span>
                </Link>
              </address>
            </div>
          </div>
